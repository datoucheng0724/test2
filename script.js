  ...
  const portfolioData = {
    system: {
      en: {
        ...
        insight: 'Although the share is gradually declining, System Business remains the backbone. The 2024–2025 launch of AI-integrated Copilot+ PCs marks a pivotal shift from traditional hardware toward generative AI devices.',
      },
      zh: {
        title: '系統產品事業群',
        badge: '💻',
        desc: '包含筆記型電腦、桌上型電腦、智慧型手機等完整系統產品，為華碩最大的營收來源。',
        products: ['筆記型電腦（ROG、Zenbook、Vivobook、ProArt）', '桌上型電腦', '一體機', '智慧型手機（ZenFone）', 'ROG Ally 掌上型電玩'],
        revenue: [['2021','64%'],['2022','67%'],['2023','63%'],['2024','60%'],['2025','52%']],
    ...
    platform: {
      en: {
        ...
        products: ['Motherboards (ROG, ProArt, TUF, Prime)', 'Graphics Cards (ROG STRIX, TUF, Dual)', 'Monitors (ROG, ProArt, TUF, ZenScreen)', 'Routers (ROG Rapture, ZenWiFi)', 'Server components'],
    ...
    aiot: {
      en: {
        ...
        badge: '🤖',
        desc: 'AI-powered solutions for smart manufacturing, smart healthcare, and smart retail — connecting edge devices with cloud intelligence.',
